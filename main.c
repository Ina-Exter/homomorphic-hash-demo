...
int main(int argc, char *argv[]){
	...
	//GMP values
	mpz_t p, q;
	mpz_init_set_str(p, "", 10);
	mpz_init_set_str(q, "223109926445955957300928869556677268552133028054427065492073534922508511836797", 10);
